        ...
        <div className="hotels">
            {hotels.map((hotel)=>(
              <div key={hotel.id} className="hotel-item">
                <img src={hotel.image} alt="" className="hotel-image" onClick={() => handleViewDetails(hotel.id)}/>
                <div className="hotel-content">
                  <span className="hotel-location">
                    <CiLocationOn className='icon' /> {hotel.location}
                  </span>
                  <span className="hotel-name" onClick={() => handleViewDetails(hotel.id)}>{hotel.name}</span>
